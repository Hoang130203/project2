...
function CardDoanhThu({ dashboard }) {
    return (
            ...
            <CardBody className="py-5">
                <div className="flex gap-2.5">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-white text-xs">{dashboard?.numberOfUsers} Người dùng</span>
                    </div>
                </div>
                <div className="flex gap-2.5 py-2 items-center">
                    <span className="text-white text-xl font-semibold">{dashboard?.totalMoney?.toLocaleString()}đ</span>
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <div>
                            ...
                            <span className="text-xs text-white">5,412,000</span>
                        </div>
                        <span className="text-white text-xs">vnd</span>
                    </div>
