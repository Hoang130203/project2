...
function LayoutAdmin({ children }) {
    const menu = [
        ...
        {
            name: "Phim", link: "/admin/users", icon:
    ...
    return (
        <div className="flex max-w-[100%]" admin={true}>
            <div className=" hidden md:block flex-none w-72 no_select">
                <a href='/' className="flex justify-center pr-5">
                    <div className={styles.logo} style={{ WebkitUserSelect: 'none', userSelect: 'none', MozUserSelect: 'none', paddingTop: '80px', color: 'olive', fontFamily: 'hazu' }}>
                ...
                <div className="fixed bg-slate-950 h-[55%] w-72 top-[20%] left-2 rounded-lg pt-4 flex flex-col justify-between">
                    <div>
                        <ul>
                            {menu.map((item, index) => (
                                <li key={index} className="p-4 pl-10 text-white hover:bg-slate-900 hover:text-blue-300 cursor-pointer flex text-lg " style={{ fontFamily: 'sans-serif', fontWeight: '600' }}>
                                    {item.icon}&nbsp;&nbsp;
                                    {item.name}
                                </li>
                            ))}
                    ...
                    <div className="flex flex-row-reverse hover:bg-slate-900 hover:text-blue-300 justify-between items-center" style={{ padding: '10px', paddingLeft: '40px' }}>
