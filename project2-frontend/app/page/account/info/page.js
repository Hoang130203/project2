...
function Favorite() {
    ...
    return (
        <div className="px-4 md:px-10 py-20 min-h-[900px]">
            <div className="flex sm:flex-row flex-col-reverse justify-start sm:justify- pb-12 mt-10">
                <div className="sm:w-[60%] md:w-[70%] md:pr-3 no_select relative group">
                    <div className="flex-col flex p-3 min-h-64 bg-opacity-65 bg-slate-950 rounded-xl text-white gap-4 justify-center items-center">
            ...
            <div className="antialiased font-sans font-normal text-sm text-white leading-6 relative items-center w-full rounded-md whitespace-pre-wrap flex justify-between px-4 rounded border border-solid bg-gray-800 border-orange-400 box-border flex-col md:flex-row min-h-[40px] mb-6">
                ...
                <div className="flex justify-center md:justify-end space-x-4 w-full md:w-auto md:my-4 mr-0 mb-4 ml-auto">
                    <button onClick={() => setShowPay(!showPay)} className="antialiased flex bg-orange-300 hover:bg-orange-500 font-sans font-medium text-sm text-gray-900 leading-6 !text-gray-900 bg-white py-1 px-4 border border-solid rounded whitespace-nowrap cursor-pointer border-orange-600 hover:bg-orange-25 justify-center min-w-[80px]" type="button">
                        <span className="antialiased font-sans font-medium text-sm text-gray-900 leading-6 ">
                            Nâng cấp
                        </span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
