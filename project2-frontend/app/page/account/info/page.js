                    ...
                    <div href="#" className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <div className="relative">
                            <div className="flex items-center">
                                ...
                                <div className="text-2xl pl-5 text-pink-100" style={{ fontFamily: 'flame' }}>Vip 1 tháng</div>
                            </div>
                            <div className="mt-6  rounded-b-[--card-border-radius] flex justify-between">
                                <div className="text-gray-700 dark:text-gray-300 text-xl" style={{ fontFamily: 'sans-serif' }}>
                                    <i> Giá:</i> <span className="text-3xl md:text-4xl text-red-300" style={{ fontFamily: 'Hazu' }}>&nbsp;100.000 vnd</span>
                                </div>
                                <div onClick={() => getVip(100000)} className="group rounded-xl   text-gray-950 bg-gray-100 hover:bg-gray-200/75   dark:bg-gray-500/10 dark:hover:bg-gray-500/15 dark:active:bg-gray-500/10 flex gap-1.5 items-center text-sm h-9 px-6 justify-center py-3 cursor-pointer text-yellow-50 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <div className="relative">
                            <div className="flex items-center">
                                ...
                                <div className=" text-2xl md:text-3xl pl-5 text-pink-300" style={{ fontFamily: 'flame' }}>Vip 3 tháng </div>
                            </div>


                            <div className="mt-6 flex justify-between rounded-b-[--card-border-radius] ">
                                <div className="text-gray-700 dark:text-gray-300 text-xl" style={{ fontFamily: 'sans-serif' }}>
                                    <i> Giá: </i> <span className="text-3xl md:text-4xl text-red-300" style={{ fontFamily: 'Hazu' }}>&nbsp;250.000 vnd</span>
                                </div>
                                <div onClick={() => getVip(250000)} className="group rounded-xl   text-gray-950 bg-gray-100 hover:bg-gray-200/75   dark:bg-gray-500/10 dark:hover:bg-gray-500/15 dark:active:bg-gray-500/10 flex gap-1.5 items-center text-sm h-9 px-6 justify-center py-3 cursor-pointer text-yellow-50 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                                    </svg>
                                    <span className="text-xl">Mua</span>
                    ...
                    <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <div className="relative">
                            <div className="flex items-center">
                                ...
                                <div className=" text-2xl pl-5 text-pink-600" style={{ fontFamily: 'flame' }}>Vip 6 tháng</div>
                            </div>
                            <div className="mt-6 flex justify-between rounded-b-[--card-border-radius] ">
                                <div className="text-gray-700 dark:text-gray-300 text-xl" style={{ fontFamily: 'sans-serif' }}>
                                    <i> Giá:</i> <span className="text-3xl md:text-4xl text-red-300" style={{ fontFamily: 'Hazu' }}>&nbsp;400.000 vnd</span>
                                </div>
                                <div onClick={() => getVip(400000)} className="group rounded-xl   text-gray-950 bg-gray-100 hover:bg-gray-200/75   dark:bg-gray-500/10 dark:hover:bg-gray-500/15 dark:active:bg-gray-500/10 flex gap-1.5 items-center text-sm h-9 px-6 justify-center py-3 cursor-pointer text-yellow-50 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                                    </svg>
                                    <span className="text-xl">Mua</span>
